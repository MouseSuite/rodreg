...
output_path = "/home/ajoshi/Desktop/rodreg/test/rodreg_output/"
...
# Output filenames
output_warped = os.path.join(output_path, "ApoE071524_C12L_warped.nii.gz")
output_label = os.path.join(output_path, "ApoE071524_C12L_warped_label.nii.gz")
