...
moving_file= '/ImagePTE1/ajoshi/code_farm/svreg/BCI-DNI_brain_atlas/BCI-DNI_brain.bfc.nii.gz'
target_file = '/home/ajoshi/Desktop/SVRegError/sub-season101_ses-2_acq-MPrageHiRes/anat/sub-season102_ses-1_acq-MPrageHiRes_T1w.bfc.nii.gz'

output_file = 'warped.bfc.nii.gz'
